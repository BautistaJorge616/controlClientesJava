...
public class ClienteDaoJDBC {
    ...
    public Cliente encontrar(Cliente cliente){
        ...
        try {
            ...
            rs = stmt.executeQuery();
            rs.absolute(1);//Nos pocisionamos en el primer registro que regrese
            ...
            //Asignar los valores que faltan al objeto que ya tenemos
    ...
    public int insertar(Cliente cliente){
        ...
        try {
            ...
            //INSERT INTO control_cliente(nombre, apellido, email, telefono, saldo) VALUES (?,?,?,?,?)
